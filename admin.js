// ========================================
// ADMIN.JS — Panel de Control Compacto
// ========================================
...
function renderSeccionesEditor() {
    ...
    const secList = [['hero', 'Hero'],['marquee', 'Marquee'],['sobre', 'Sobre Nosotros'],['quienesSomos', 'El Equipo'],['testimonios', 'Testimonios'],['audiovisual', 'Videos y Reels'],['fotos', 'Fotografía'],['branding', 'Branding'],['redes', 'Redes Sociales'],['webdev', 'Web y Código'],['contacto', 'Contacto']];
...
function renderVideosH() {
    ...
    container.innerHTML = '<div class="admin-card" id="vhCard"><h3>Videos Horizontales</h3></div>';
...
function renderPhotos() {
    ...
    container.innerHTML = '<div class="admin-card" id="pCard"><h3>Galería (Con descripciones)</h3></div>';
    const list = document.createElement('div');
