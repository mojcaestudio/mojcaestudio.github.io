...
function initAdmin() {
    currentData = getData();
    if (!currentData) {
        // Si no hay datos, cargar defaults desde main.js
        ...
        <div class="item-card" data-id="${v.id}">
            <div class="item-card-header">
                ...
                <div class="item-card-actions">
                    ...
                    <button onclick="deleteItem('video-h', '${v.id}')">Eliminar</button>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group-admin">
        ...
        <div class="item-card" data-id="${v.id}">
            <div class="item-card-header">
                ...
                <div class="item-card-actions">
                    ...
                    <button onclick="deleteItem('video-v', '${v.id}')">Eliminar</button>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group-admin">
...
function renderPhotoGrid() {
    ...
    // Mostrar hasta 12 celdas (o mas si hay mas fotos)
        ...
        if (photo) {
            cell.innerHTML = `
                <div class="cell-actions">
                    ...
                    <button onclick="event.stopPropagation();deleteItem('foto', '${photo.id}')" title="Eliminar">✕</button>
                </div>
...
function editItem(section, id) {
    // Para items que no tienen edicion inline completa, abrir modal
    if (section === 'branding') {
        currentEditId = id;
