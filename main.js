...
const DEFAULT_DATA = {
    texts: {
        ...
        contactEmail: "hola@mojcaestudio.com",
    ...
    redes: [
        { id: "r1", type: "carousel", slides: [{ src: "", label: "Campaña Verano 1/3" }, { src: "", label: "Campaña Verano 2/3" }, { src: "", label: "Campaña Verano 3/3" }], likes: "1,247", caption: "Nueva campana de verano para @marcacliente.", hashtags: "#audiovisual #redessociales", time: "Hace 2 dias", location: "Buenos Aires, Argentina" },
...
class InfiniteCarousel {
    ...
    cloneItems() {
        ...
        // Clonar al principio y al final para efecto infinito
    ...
    setupVideoHandling() {
        // Manejar videos: muteados por defecto, al clickear activar audio bajo
        ...
        // Click fuera del carrusel silencia todo
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Inicializar carruseles infinitos
    document.querySelectorAll('.carousel-outer').forEach(outer => {
        new InfiniteCarousel(outer);
    });

    // Re-activar scroll reveal despues de render dinamico
    setTimeout(() => {
