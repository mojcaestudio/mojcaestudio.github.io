...
// ========================================
// SPOTLIGHT DE CURSOR EN EL HERO
// ========================================
function initHeroSpotlight() {
    const hero = document.getElementById('inicio');
    const glass = document.getElementById('heroGlass');
    if (!hero || !glass) return;

    // Evitar el efecto en touch (no hay cursor real)
    ...
    hero.addEventListener('mousemove', (e) => {
        ...
        glass.style.background = `radial-gradient(650px circle at ${x}% ${y}%, rgba(255,140,66,0.16), rgba(255,255,255,0.05) 40%)`;
    });
